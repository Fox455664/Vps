    ...
    if command == "/pause" or command == "ايقاف مؤقت":
       ...
       if videoid:
         if userx.photo:
            ...
            ahmed = await client.get_chat("UP_PR0")
